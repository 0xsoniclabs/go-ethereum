...
SONIC_HOOK_TESTS = ^(TestCallInterceptor_|TestCustomCodeSize_|TestEthTransferLogs|TestGetInterpreter_|TestSonicHookRegistry_|TestStatePrecompiles_|TestStateTransition_)
